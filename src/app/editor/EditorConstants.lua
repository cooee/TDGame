...
EditorConstants.SELECTED_LABEL_COLOR   = {255, 0, 255}
EditorConstants.UNSELECTED_COLOR       = {0, 255, 0, 255}
EditorConstants.UNSELECTED_LABEL_COLOR = {255, 255, 255}
EditorConstants.LABEL_OFFSET_Y         = 4
EditorConstants.LABEL_FONT             = DEFAULT_FONT
