...
defines["LightBulletAnim"] = decoration


local decoration = {
    framesName   =  "light_tower_2_%d.png",
    framesBegin  = 1,
    framesLength = 5,
    framesTime   = 0.8 / 5,
    zorder       = 1,
...
defines["PlayerTower03L01FireAnim"] = decoration


-- local decoration = {
--     framesName   =  "gun_tower_1_%d.png",
--     framesBegin  = 1,
--     framesLength = 5,
--     framesTime   = 0.8 / 5,
--     zorder       = 1,
...
--     bulletDelay  = 0.8,
-- }
-- defines["PlayerTower02FireAnim"] = decoration
...
defines["Tower02L01FireAnim"] = decoration

local decoration = {
    framesName   =  "gun_tower_2_%d.png",
    framesBegin  = 1,
    framesLength = 5,
    framesTime   = 0.8 / 5,
    zorder       = 1,
...
defines["Tower02L02FireAnim"] = decoration


local decoration = {
    framesName   = "PlayerTower01Fire%04d.png",
    framesBegin  = 1,
    framesLength = 8,
    framesTime   = 0.48 / 8,
    zorder       = 1,
...
defines["PlayerTower01Fire"] = decoration
