...
local BehaviorBase = require("game.map.behaviors.BehaviorBase")
...
function MovableBehavior:setNextPosition(object)
    ...
    local direction = self:getMOveDirection(object);
...
function MovableBehavior:bind(object)
    ...
    local function setSpeed(object, maxSpeed)
        ...
        object.speedDecr_ = object.speed_ * 0.025 * MovableBehavior.SPEED_SCALE
